...
def menu():
    ...
    print("16. Form groups of k passengers from the same plane, but with different last names")
   ...
   # try:
    while True:
        ...
        if cmd == 0:
            ...
            system("cls || clear")
            print(Fore.CYAN + "You have chosen to form groups with different last names\n"+ Style.RESET_ALL)
            k = int(input("How many passengers do you want to have in a group? :"))
            print()
            sleep(0.01)
            print(airport.passGroup(k))
        elif cmd<0 or cmd>16:
